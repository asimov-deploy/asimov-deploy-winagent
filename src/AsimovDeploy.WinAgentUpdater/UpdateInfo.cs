namespace AsimovDeploy.WinAgentUpdater {
	...
	public class UpdateInfo {
		...
		public bool HasLastBuild {
			get { return LastBuild != null; }
		}
		public bool HasLastConfig {
			get { return LastConfig != null; }
		}
		...
		public override string ToString() {
			return string.Format("Current Build: {0}, Current ConfigVersion: {1}, LatestBuild: {2}, LatestConfig: {3}",
			                     Current.Version, Current.ConfigVersion,
			                     HasLastBuild ? LastBuild.Version.ToString() : "NA",
			                     HasLastConfig ? LastConfig.Version.ToString() : "NA");
		}
